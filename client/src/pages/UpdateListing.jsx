...
export default function UpdateListing() {
  ...
  return (
    <main className='p-6 max-w-4xl mx-auto'>
            <h1 className='text-4xl font-semibold text-center mb-8'>Update Listing</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-8'>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-green-500 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading ? 'Updating...' : 'Update Listing'}</button>
